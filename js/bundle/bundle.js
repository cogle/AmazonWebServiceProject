...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	   ...
	   _createClass(App, [{
	      ...
	      key: 'setBucketName',
	      value: function setBucketName(name) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BucketList = function (_React$Component) {
	    ...
	    _createClass(BucketList, [{
	        ...
	        key: 'loadBucketsFromServer',
	        value: function loadBucketsFromServer() {
	            $.ajax({
	                type: "GET",
	                url: "/get_bucket_list",
	                dataType: 'json',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BucketRow = function (_React$Component) {
	     _inherits(BucketRow, _React$Component);

	     function BucketRow(props) {
	          _classCallCheck(this, BucketRow);

	          return _possibleConstructorReturn(this, Object.getPrototypeOf(BucketRow).call(this, props));
	     }
